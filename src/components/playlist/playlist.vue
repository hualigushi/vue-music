<template>
  <transition name="list-fade">
    <div class="playlist" v-show="showFlag" @click="hide">
      ...
      <confirm ref="confirm" @confirm="confirmClear" text="是否清空播放列表" confrimBtnText="清空"></confirm>
...
export default {
  ...
  methods: {
    ...
    deleteOne (item) {
      ...
      if (!this.playlist.length) { // 如果全部删去就隐藏
        this.hide();
      }
    },
    showConfirm () {
